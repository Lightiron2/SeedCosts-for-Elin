...
"Palulu" = 2.0,"Pear" = 3.0,"Rainbow" = 8.0}
const Grass: Dictionary = {"Weed" = 1.0}
...
const Straw: Dictionary = {"Rice" = 0.0,"Wheat" = 3.0}
const Trees: Dictionary = {"Birch" = 0.0,"Cedar" = 0.0,"Cherry" = 0.0,"Coral" = 0.0,"Fir" = 0.0,
"Mushroom Tree" = 0.0,"Oak" = 0.0,"Pine" = 0.0,"Rosewood" = 0.0,}
const Vegetable: Dictionary = {"Bamboo" = 0.0,"Cabbage" = 0.0,"Cabocchi" = 0.0,"Carrot" = 0.0,
"Corn" = 0.0,"Imo" = 0.0,"Radish" = 0.0,"SeaweedDeep" = 0.0,"Tomato" = 1.0,}

const seedCostArray: Array[Dictionary] = [Flowers,Fruit,Grass,Herb,Mushroom,Nuts,Pasture,Straw,Trees,Vegetable]
#mushroom,nuts,pasture,straw,vegetable
#Fruit, Flora, Grass, Herb

var FlowersChosen: Dictionary = {"Normal" = 5.0,"Blue" = 0.0,"White" = 0.0,"Yellow" = 0.0}
var FruitChosen: Dictionary = {"Apple" = 0.0,"Banana" = 0.0,"Berry" = 0.0,"Cactus" = 0.0,"Grape" = 0.0,
"Palulu" = 0.0,"Pear" = 0.0,"Rainbow" = 0.0}
var GrassChosen: Dictionary = {"Weed" = 0.0}
...
var TreesChosen: Dictionary = {"Birch" = 0.0,"Cedar" = 0.0,"Cherry" = 0.0,"Coral" = 0.0,"Fir" = 0.0,
"Mushroom Tree" = 0.0,"Oak" = 0.0,"Pine" = 0.0,"Rosewood" = 0.0,}
...
var mutableDicsArray: Array[Dictionary] = [FlowersChosen,FruitChosen,GrassChosen,HerbChosen,MushroomChosen,
	NutsChosen,PastureChosen,StrawChosen,TreesChosen,VegetableChosen]
...
@export var costDifLabel: Label

var nameTarget: String = "No Target"

func _ready() -> void:
	var count: float = 0.0
	for key in mutableDicsArray[0]:
		count += seedCostArray[0][key] * mutableDicsArray[0][key]
		print(key,"   ",count)
	updateFertilityLabels()
...
func updateFertilityLabels():
	...
	costDifLabel.text = str(newFertDif)
	if newFertDif < 0:
		print("negative")
		costDifLabel.add_theme_color_override("font_color",Color(0.6, 0.0, 0.0))
		return
	if newFertDif > 0:
		print("positive")
		costDifLabel.add_theme_color_override("font_color",Color(0.0, 0.8, 0.0))
		return
	if newFertDif == 0:
		print("neutral")
		costDifLabel.add_theme_color_override("font_color",Color(0.4, 0.4, 0.4))
		return
...
#	for key in mutableDicsArray[index]:
#		var das = seedCostArray[index][key] * mutableDicsArray[index][key]
#		seedList.items
...
var ifResetting: bool = false
func _on_reset_safety_item_clicked(index: int, at_position: Vector2, mouse_button_index: int) -> void:
	if index == 0:
